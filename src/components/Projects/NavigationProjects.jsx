  ...
  return (
    <div className="drawer ">
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 w-80 min-h-full  bg-ProjectSlider bg-cover bg-center text-white text-semibold">

          <li>
            <a className="font-semibold text-2xl my-2 py-4 px-6 rounded-lg bg-black/20 text-white shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
              Projects Backend
            </a>
          </li>
          <li>
